"""
logging_config.py
Central logging configuration for the Gmail AI Agent.
...
def setup_logging(level: int = logging.INFO) -> None:
    ...
    Output format:
        2026-06-15 12:34:56 | INFO     | agent_gmail.tools | message here
    ...
    # Silence third-party loggers that are too verbose at INFO level
